select
	t.*,
    coalesce(lead(t.load_ts) over(partition by t.hk_employee order by t.load_ts) - interval 1 milliseconds, to_timestamp('2099-12-31 23:59:59.999', 'yyyy-MM-dd HH:mm:ss.SSS')) as loadend_ts,
	...
	coalesce(usrAccount.usr_login_name, t.usr_account_id) as usr_account_name
...
left outer join {{ ref('r_user') }} usrAccount
	on usrAccount.usr_rowid = t.usr_account_id
