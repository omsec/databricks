...
select
	...
	case
		when t.cst_created_at between to_date('2011-01-01', 'yyyy-MM-dd') and to_date('2020-02-15', 'yyyy-MM-dd') then
			upper(substring(t.usr_created_by_login_name, 1, position('-', t.usr_created_by_login_name) - 1))
		else
	...
	case
		when t.cst_modified_at between to_date('2011-01-01', 'yyyy-MM-dd') and to_date('2020-02-15', 'yyyy-MM-dd') then
			upper(substring(t.usr_modified_by_login_name, 1, position('-', t.usr_modified_by_login_name) - 1))
		else
	...
	case
		when t.cst_deleted_at between to_date('2011-01-01', 'yyyy-MM-dd') and to_date('2020-02-15', 'yyyy-MM-dd') then
			upper(substring(t.usr_deleted_by_login_name, 1, position('-', t.usr_deleted_by_login_name) - 1))
		else
	...
	array('jira-10000', 'jira-20000', 'jira-30000') as dwh_applied_issues
